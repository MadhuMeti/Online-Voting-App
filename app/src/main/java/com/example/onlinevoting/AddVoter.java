        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(usn.equals("") || pwd.equals(""))
                {
                    ...
                    Toast.makeText(AddVoter.this, "Invalid USN",
                            Toast.LENGTH_SHORT).show();
                }
                else {
                    status = mydb.addVoter(addusn.getText().toString(),
                            addpwd.getText().toString());
                    if (status) {
                        Toast.makeText(AddVoter.this, "Voter Added",
                                Toast.LENGTH_SHORT).show();
                        addusn.setText("");
                        addpwd.setText("");
                        startActivity(new
                                Intent(AddVoter.this,AdminPage.class));
                        finish();
                    } else {
